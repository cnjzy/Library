...
public class XRecyclerView extends RecyclerView {
    ...
    public AbsRefreshHeader getDefaultRefreshHeaderView() {
        if (mRefreshHeader == null) {
            return null;
        }
    ...
    public int getLimitNumberToCallLoadMore() {
        return limitNumberToCallLoadMore;
    }
    ...
    public void setRefreshHeader(AbsRefreshHeader refreshHeader) {
    ...
    public int getItemCount() {
        LayoutManager layoutManager = getLayoutManager();
        return layoutManager.getItemCount() + getHeaders_includingRefreshCount();
    }
    ...
    public void showLoadMore() {
        if (mFootView != null && mFootView instanceof LoadingMoreFooter) {
            ((LoadingMoreFooter) mFootView).setState(LoadingMoreFooter.STATE_LOADING);
        }
        mLoadingListener.onLoadMore();
    }
